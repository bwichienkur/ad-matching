...
{
    public class ClientAdAccountParameterRepository : GenericReadOnlyRepository<ClientAdAccountParameter>, IClientAdAccountParameterRepository
    {
        public ClientAdAccountParameterRepository(GlassPanelContext dbContext) : base(dbContext) { }
