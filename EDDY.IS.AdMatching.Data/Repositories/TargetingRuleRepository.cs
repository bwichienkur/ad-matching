...
{
    public class TargetingRuleRepository : GenericReadOnlyRepository<TargetingRule>, ITargetingRuleRepository
    {
        public TargetingRuleRepository(GlassPanelContext dbContext) : base(dbContext) { }
