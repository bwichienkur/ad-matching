...
{
    public class StateTimeZoneRepository : GenericReadOnlyRepository<Entities.StateTimeZone>, IStateTimeZoneRepository
    {
        public StateTimeZoneRepository(GlassPanelContext dbContext) : base(dbContext) { }
