...
{
    public class TimeZoneRepository : GenericReadOnlyRepository<Entities.TimeZone>, ITimeZoneRepository
    {
        public TimeZoneRepository(GlassPanelContext dbContext) : base(dbContext) { }
