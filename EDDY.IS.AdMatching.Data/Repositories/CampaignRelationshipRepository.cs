...
{
    public class CampaignRelationshipRepository : GenericReadOnlyRepository<CampaignRelationship>, ICampaignRelationshipRepository
    {
        public CampaignRelationshipRepository(GlassPanelContext dbContext) : base(dbContext) { }
