...
{
    public class SourceByCampaignRepository : GenericReadOnlyRepository<VwSourceByCampaignAms>, ISourceByCampaignRepository
    {
        public SourceByCampaignRepository(GlassPanelContext dbContext) : base(dbContext) { }
