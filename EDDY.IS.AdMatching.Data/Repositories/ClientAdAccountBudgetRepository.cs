...
{
    public class ClientAdAccountBudgetRepository : GenericReadOnlyRepository<ClientAdAccountBudget>, IClientAdAccountBudgetRepository
    {
        public ClientAdAccountBudgetRepository(GlassPanelContext dbContext) : base(dbContext) { }
