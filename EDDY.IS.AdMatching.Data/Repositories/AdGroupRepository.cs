...
{
    /// <summary>
    /// AdGroupRepository repository implements IAdGroupRepository with specific method implementations and inherits common methods from GenericReadOnlyRepository
    /// </summary>
    public class AdGroupRepository : GenericReadOnlyRepository<AdGroup>, IAdGroupRepository
    {

        public AdGroupRepository(GlassPanelContext dbContext) : base(dbContext) { }
