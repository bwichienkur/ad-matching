...
{
    public class SlimAdsAMSRepository: GenericReadOnlyRepository<SlimAd>, ISlimAdsAMSRepository
    {
        public SlimAdsAMSRepository(GlassPanelContext dbContext) : base(dbContext) { }
