...
{
    public class CampaignStopRepository : GenericReadOnlyRepository<CampaignStop>, ICampaignStopRepository
    {

        public CampaignStopRepository(GlassPanelContext dbContext) : base(dbContext) { }
