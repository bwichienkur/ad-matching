...
{
    public class AccountStopRepository:GenericReadOnlyRepository<ClientAdAccountStop>, IClientAccountStopRepository
    {

        public AccountStopRepository(GlassPanelContext dbContext) : base(dbContext) { }
