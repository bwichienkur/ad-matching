...
{
    public class SourceProductTypeRepository : GenericReadOnlyRepository<SourceProductType>, ISourceProductTypeRepository
    {
        public SourceProductTypeRepository(GlassPanelContext dbContext) : base(dbContext) { }
